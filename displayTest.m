...
while true
    ...
    if keyPressed && NumInt >= 0
        AlarmHoursOne = NumInt;
        disp(NumInt); pause(0.2); break
    end
end
...
while true
    ...
    if exist('confirmed', 'var'); break; end
end
...
temp = input('How hard would you like the code? From 0.01 to 1: ');
Sleven = 0;
if AlarmHoursStr > 9
